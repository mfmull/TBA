...
res_files <- list.files("../2_RunAnalysis/resultOut", pattern = "\\.qs$", full.names = TRUE)
...
p1=combine_res_mirrored_density_plots(list(IrIntens,Overdraft,IrRivsInt),ylb='Irrig. Intensity [-]')
IrGini$label='Irrigation'
IrRivsGini$label="Irrig | Rivers"
GWGini$label="GW Irrig."
GWRivsGini$label="GW Irrig. | Rivers"
p2=combine_res_mirrored_density_plots(list(IrGini,IrRivsGini,GWGini,GWRivsGini),ylb='Gini Index')
