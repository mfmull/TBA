...
diadsF <- diads %>%
  mutate(
    ...
    GW_B11_1 = pmax(GW_B11_1, CR3_B11_1),
    GW_B11_2 = pmax(GW_B11_2, CR3_B11_2)
  ) %>%
  mutate(
    rG1_1 = GW_B11_1 / GW_1,
    rG1_2 = GW_B11_2 / GW_2,
...
ggsave("./plts/B5/cls_1.pdf",p1,width=4,height=3)
...
write.csv(data_alluvial,
          "./plts/B5/data_cls_1_alluvial.csv",
          row.names=FALSE)
...
ggsave("./plts/B5/cls_2.pdf",ptuck,width=5,height=3)
