...
ggsave("./plts/thresh/cls_1.pdf",p1,width=4,height=3)
...
write.csv(data_alluvial,
          "./plts/thresh/data_cls_1_alluvial.csv",
          row.names=FALSE)
...
ggsave("./plts/thresh/cls_2.pdf",ptuck,width=5,height=3)
...
write.csv(data_tukey,
          "./plts/thresh/data_cls_2_bars.csv",
          row.names=FALSE)
