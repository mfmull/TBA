...
ggsave("./plts/eps/cls_1.pdf",p1,width=4,height=3)
...
write.csv(data_alluvial,
          "./plts/eps/data_cls_1_alluvial.csv",
          row.names=FALSE)
...
ggsave("./plts/eps/cls_2.pdf",ptuck,width=5,height=3)
